<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sell2.aspx.cs" Inherits="FMS.sell2" %>
        ...
        <div class="card-body" style="background-color:#bdf6b6">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <asp:TextBox ID="TextBox12" runat="server" CssClass="form-control" TextMode="Number" Enabled="false" ></asp:TextBox>
                ...
                <div class="col-md-3">
                    <asp:Label ID="Label13" runat="server" Text="Grand price "></asp:Label>
                        <asp:TextBox ID="TextBox13" runat="server" CssClass="form-control" AutoPostBack="True" ></asp:TextBox>
        ...
        <div class=" card-footer">
          ...
          <div class="card-footer">
                <div class="alert-warning">
                   <p>This page used to sell and produce bill for the costomer</p>
