<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invoice.aspx.cs" Inherits="FMS.invoice"  EnableEventValidation="false" %>
...
<body>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                <div class="col-6 col-sm-3">
                                    <asp:Label ID="Label2" runat="server" Text="Costomer ID"></asp:Label></div>
                                <div class="col-6 col-sm-3">
                                    <asp:Label ID="Label3" runat="server" Text=""></asp:Label></div>
                             <div class="w-100"></div>
                             <div class="col-6 col-sm-3">
                                    <asp:Label ID="Label4" runat="server" Text="Costomer name "></asp:Label></div>
                                <div class="col-6 col-sm-3">
        ...
        <asp:Button ID="Button4" runat="server" class="btn btn-primary" Text="Home" type="button" OnClick="Button4_Click" />
            <asp:Button ID="Button1" runat="server" Text="invoice" OnClick="Button1_Click" />
        </div>
        <br />
        <br />
