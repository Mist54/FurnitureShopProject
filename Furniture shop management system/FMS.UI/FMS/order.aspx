<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="FMS.order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card text-dark" >
                ...
                <div class="card-body"  style="background-color:#bdf6b6">
                    <div class="row">
                        <div class="col-md-6">
                             <asp:Label ID="Label3" runat="server" Text="Contact NO." Width="100px"></asp:Label>
                    ...
                    <div class="col-md-6">
                                ...
                                &nbsp;<asp:Button ID="Button8" runat="server" Width="130px" CssClass="btn btn-outline-danger"   OnClick="Button8_Click" /></div>
                         <div class="col-md-6">
                                &nbsp;&nbsp; <asp:Button ID="Button1" runat="server" Text="Save" CssClass=" btn btn-success" Width="130px" OnClick="Button1_Click" />
                            &nbsp;&nbsp;<asp:Button ID="Button6" runat="server" Text="Search" CssClass=" btn btn-warning"  Width="130px" OnClick="Button6_Click"  />
                            &nbsp;<asp:Button ID="Button4" runat="server" Text="View all" CssClass="btn btn-dark"  Width="130px" OnClick="Button4_Click"  />
                            &nbsp;<asp:Button ID="Button5" runat="server" Text="Reset" CssClass=" btn btn-light"  Width="130px" OnClick="Button5_Click"/></div>
