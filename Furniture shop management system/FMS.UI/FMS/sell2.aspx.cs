...
namespace FMS
{
    public partial class sell2 : System.Web.UI.Page
    {
        float pr, tot, gt;
        int qty,dis;
        ...
        protected void TextBox9_TextChanged(object sender, EventArgs e)
        {
            if (TextBox9.Text == "&")
            {
                Response.Write("<script>alert('Inavild Input  !!')</script>");
            }
              ...
              TextBox7.Text != "" && TextBox8.Text != "")
            {
                ...
                pr = Convert.ToSingle(TextBox10.Text);
                tot = qty * pr;
            ...
            {
                Response.Write("<script>alert('Inavild Input or enter all the records !!')</script>");
                TextBox9.Text = "";
            }    
        }
